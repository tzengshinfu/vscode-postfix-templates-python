...
describe('Single line template tests', () => {
  ...
  Test('new template - identifier                   | Type{new}           >> Type()')
  Test('new template - property access expression   | namespace.Type{new} >> namespace.Type()')
  Test('new template - assignment binary expression | a = B{new}          >> a = B()')
